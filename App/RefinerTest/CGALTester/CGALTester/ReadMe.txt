========================================================================
    KONSOLENANWENDUNG: CGALTester-Projektübersicht
========================================================================

Diese CGALTester-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre CGALTester-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen CGALTester.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
